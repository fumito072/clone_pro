...
Google Cloud Speech-to-Text APIを使って音声セグメントの文字起こしを自動生成
...
# 全WAVファイルを取得（segment_0001.wav, segment_0002.wav, ...）
...
if transcriptions or existing_lines:
    ...
    if transcriptions:
        ...
        if len(transcriptions) > 10:
            print(f"   ... 他 {len(transcriptions) - 10}件")
...
print("   2. 学習用メタデータファイル（utt2spk, spk2utt, wav.scp）を生成")
print()
